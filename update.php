...
if(isset($_GET['update_id'])){
    ...
    $select_query="Select * from `fill` where id=$uid";
    ...
    if(isset($_POST['update'])){
      ...
      $update_query="update `fill` set username='$username_update',email='$email_update',phone='$phone_update',place='$place_update' where id=$uid";
